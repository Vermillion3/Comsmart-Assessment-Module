...
export default function PCRecommendationScreen({ route }) {
  const navigation = useNavigation();
  const [active, setActive] = useState('PC Recommendations');
  ...
  return (
    <SidebarLayout activeTab="PC Recommendations" user={user}>
